...
export const modules: Module[] = [
  {
    ...
    lessons: [
      { id: 1, title: "What is money?", duration: 1, status: "in-progress", watchProgress: 0, videoId: "80Pp66Ye5Vk", videoUrl: "/videos/module1-lesson1.mp4" },
      { id: 2, title: "A brief history of currency", duration: 1, status: "in-progress", watchProgress: 0, videoId: "Lys4EVugJmk", videoUrl: "/videos/module1-lesson2.mp4" },
      { id: 3, title: "How prices work", duration: 1, status: "in-progress", watchProgress: 0, videoId: "-nsGtO2c4pw", videoUrl: "/videos/module1-lesson3.mp4" },
      { id: 4, title: "Supply, demand, and you", duration: 1, status: "in-progress", watchProgress: 0, videoId: "uudPHdBBPO4", videoUrl: "/videos/module1-lesson4.mp4" },
      { id: 5, title: "Inflation and your wallet", duration: 1, status: "in-progress", watchProgress: 0, videoId: "-Z5kkfrEc8I", videoUrl: "/videos/module1-lesson5.mp4" },
    ],
    takeaways: [
  ...
  },
  {
    ...
    lessons: [
      { id: 1, title: "Pay yourself first", duration: 1, status: "in-progress", watchProgress: 0, videoId: "k-RTEIaYvAg", videoUrl: "/videos/module2-lesson1.mp4" },
      { id: 2, title: "Building an emergency fund", duration: 1, status: "in-progress", watchProgress: 0, videoId: "n4YoZDQs6VA", videoUrl: "/videos/module2-lesson2.mp4" },
      { id: 3, title: "Goal-based savings buckets", duration: 1, status: "in-progress", watchProgress: 0, videoId: "cnW_HDIBmz4", videoUrl: "/videos/module2-lesson3.mp4" },
      { id: 4, title: "Beating lifestyle creep", duration: 1, status: "in-progress", watchProgress: 0, videoId: "HTaciA7Ttds", videoUrl: "/videos/module2-lesson4.mp4" },
      { id: 5, title: "Automating your savings", duration: 1, status: "in-progress", watchProgress: 0, videoId: "jhvCc5tKAno", videoUrl: "/videos/module2-lesson5.mp4" },
    ],
    takeaways: [
  ...
  },
  {
    ...
    lessons: [
      { id: 1, title: "How credit scores work", duration: 1, status: "in-progress", watchProgress: 0, videoId: "ozbGWLtZdoY", videoUrl: "/videos/module3-lesson1.mp4" },
      { id: 2, title: "Types of debt: good vs. bad", duration: 1, status: "in-progress", watchProgress: 0, videoId: "jIltXZYAZog", videoUrl: "/videos/module3-lesson2.mp4" },
      { id: 3, title: "Reading your credit report", duration: 1, status: "in-progress", watchProgress: 0, videoId: "-XNo7C8Bsvw", videoUrl: "/videos/module3-lesson3.mp4" },
      { id: 4, title: "Getting out of debt fast", duration: 1, status: "in-progress", watchProgress: 0, videoId: "zhViwFVl6R0", videoUrl: "/videos/module3-lesson4.mp4" },
      { id: 5, title: "Building credit from scratch", duration: 1, status: "in-progress", watchProgress: 0, videoId: "VrOB35_7QCE", videoUrl: "/videos/module3-lesson5.mp4" },
    ],
    takeaways: [
  ...
  },
  {
    ...
    lessons: [
      { id: 1, title: "Checking vs. savings accounts", duration: 1, status: "in-progress", watchProgress: 0, videoId: "E-HOz8T6tAo", videoUrl: "/videos/module4-lesson1.mp4" },
      { id: 2, title: "How direct deposit works", duration: 1, status: "in-progress", watchProgress: 0, videoId: "szUhmDH98oQ", videoUrl: "/videos/module4-lesson2.mp4" },
      { id: 3, title: "Reading a pay stub", duration: 1, status: "in-progress", watchProgress: 0, videoId: "9_sVeFmaVmw", videoUrl: "/videos/module4-lesson3.mp4" },
      { id: 4, title: "Taxes: what comes out and why", duration: 1, status: "in-progress", watchProgress: 0, videoId: "SfKSOU729fM", videoUrl: "/videos/module4-lesson4.mp4" },
      { id: 5, title: "Reading a bank statement", duration: 1, status: "in-progress", watchProgress: 0, videoId: "lRajjjXJVL8", videoUrl: "/videos/module4-lesson5.mp4" },
    ],
    takeaways: [
  ...
  },
  {
    ...
    lessons: [
      { id: 1, title: "The magic of compound growth", duration: 1, status: "in-progress", watchProgress: 0, videoId: "Rm6UdfRs3gw", videoUrl: "/videos/module5-lesson1.mp4" },
      { id: 2, title: "Index funds explained", duration: 1, status: "in-progress", watchProgress: 0, videoId: "SFdsY9Rdh6w", videoUrl: "/videos/module5-lesson2.mp4" },
      { id: 3, title: "Risk vs. return", duration: 1, status: "in-progress", watchProgress: 0, videoId: "7mo167ohvJw", videoUrl: "/videos/module5-lesson3.mp4" },
      { id: 4, title: "Opening a brokerage account", duration: 1, status: "in-progress", watchProgress: 0, videoId: "ro3v84swtZ4", videoUrl: "/videos/module5-lesson4.mp4" },
      { id: 5, title: "Starting with $50 a month", duration: 1, status: "in-progress", watchProgress: 0, videoId: "mec-QpjQMXY", videoUrl: "/videos/module5-lesson5.mp4" },
    ],
    takeaways: [
  ...
  },
  {
    ...
    lessons: [
      { id: 1, title: "Why insurance exists", duration: 1, status: "in-progress", watchProgress: 0, videoId: "YmB8h9eEPMw", videoUrl: "/videos/module6-lesson1.mp4" },
      { id: 2, title: "Health insurance basics", duration: 1, status: "in-progress", watchProgress: 0, videoId: "WTtjmdyTCRM", videoUrl: "/videos/module6-lesson2.mp4" },
      { id: 3, title: "Auto and renters insurance", duration: 1, status: "in-progress", watchProgress: 0, videoId: "x0mTQjshRUo", videoUrl: "/videos/module6-lesson3.mp4" },
      { id: 4, title: "Life insurance: do you need it?", duration: 1, status: "in-progress", watchProgress: 0, videoId: "AgBhy8iXjpI", videoUrl: "/videos/module6-lesson4.mp4" },
      { id: 5, title: "Spotting the upsells", duration: 1, status: "in-progress", watchProgress: 0, videoId: "2yWDKDm-ZD8", videoUrl: "/videos/module6-lesson5.mp4" },
    ],
    takeaways: [
  ...
  },
  {
    ...
    lessons: [
      { id: 1, title: "Renting vs. buying a home", duration: 1, status: "in-progress", watchProgress: 0, videoId: "NdYfSYfJpLE", videoUrl: "/videos/module7-lesson1.mp4" },
      { id: 2, title: "The true cost of a car", duration: 1, status: "in-progress", watchProgress: 0, videoId: "L8KmT-ZX9GU", videoUrl: "/videos/module7-lesson2.mp4" },
      { id: 3, title: "The real price of college", duration: 1, status: "in-progress", watchProgress: 0, videoId: "SAjZj3ZwebA", videoUrl: "/videos/module7-lesson3.mp4" },
      { id: 4, title: "How to compare big choices", duration: 1, status: "in-progress", watchProgress: 0, videoId: "CBJ3_A5SMsc", videoUrl: "/videos/module7-lesson4.mp4" },
      { id: 5, title: "Decision frameworks that work", duration: 1, status: "in-progress", watchProgress: 0, videoId: "b4BzYHFnOZw", videoUrl: "/videos/module7-lesson5.mp4" },
    ],
    takeaways: [
  ...
  },
  {
    ...
    lessons: [
      { id: 1, title: "Retirement accounts explained", duration: 1, status: "in-progress", watchProgress: 0, videoId: "J9lTE95LPaA", videoUrl: "/videos/module8-lesson1.mp4" },
      { id: 2, title: "The 401(k) and IRA compared", duration: 1, status: "in-progress", watchProgress: 0, videoId: "2zfdtmlMNDs", videoUrl: "/videos/module8-lesson2.mp4" },
      { id: 3, title: "Real estate as an investment", duration: 1, status: "in-progress", watchProgress: 0, videoId: "HQbEU5Vqsk4", videoUrl: "/videos/module8-lesson3.mp4" },
      { id: 4, title: "Generational wealth basics", duration: 1, status: "in-progress", watchProgress: 0, videoId: "KA66Wcp1QEc", videoUrl: "/videos/module8-lesson4.mp4" },
      { id: 5, title: "Writing your financial plan", duration: 1, status: "in-progress", watchProgress: 0, videoId: "6JxWW4hLS1U", videoUrl: "/videos/module8-lesson5.mp4" },
    ],
    takeaways: [
